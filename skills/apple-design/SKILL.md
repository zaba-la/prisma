...
<!--
Vendored from https://github.com/emilkowalski/skills (MIT License, Copyright (c) 2026 Emil Kowalski).
Unmodified except for the "Prisma house rule" section appended at the end of this file.
See docs/tools.md for how this fits into the Prisma toolkit, and LICENSES/emilkowalski-skills-LICENSE.txt
...
This skill owns the technical physics of spring-based, interruptible motion: velocity, momentum, spatial continuity. It does not decide whether a screen should feel "Apple-like", that is a brand decision that belongs in the project's design contract (`design-system`). If this skill's guidance conflicts with the contract's stated motion personality, the contract wins.
