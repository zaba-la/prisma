...
This skill owns naming: turning a vague description of a motion effect into its exact term. It does not decide whether an effect belongs in this product, that call, and every aesthetic call, comes from the project's design contract (`design-system`).
