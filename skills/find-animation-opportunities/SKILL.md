...
This skill owns spotting where motion is mechanically warranted and proposing exact values. It does not set brand-level motion personality, that is defined once in the project's design contract (`agents/prisma.md` §5) and this skill's proposals must fit inside it.
