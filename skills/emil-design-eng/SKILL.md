...
This skill's aesthetic opinions are a reference point, not a substitute for the project's design contract (`design-system`). When the two conflict, the contract wins, route the disagreement back through design-system governance rather than resolving it here.
